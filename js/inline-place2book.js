...
jQuery(document).ready(function($) {
	$('.inline-place2book-ticketinfo').each(function() { 
	    var obj = this;
            $(obj).parent().append("<div class='inline-p2b_preloader'><a href='https://place2book.com/da/14540/list/EM3892'>Bestil billet(ter)</a><span class='fa fa-cog fa-spin fa fa-fw'></span><div>");
